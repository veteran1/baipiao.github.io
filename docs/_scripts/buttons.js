...
! function() {
    ...
    var e = window.document,
        ...
        f = function(e, t, o) { e.addEventListener ? e.addEventListener(t, o, !1) : e.attachEvent("on" + t, o) },
        ...
        g = function(e, t, o) {
            var r = "readystatechange",
                a = function() { if (t.test(e.readyState)) return h(e, r, a), o.apply(this, arguments) };
            f(e, r, a)
        },
        p = function(e) {
        ...
        F = function(e, t) {
            var o = C[e] || (C[e] = []);
            if (!(o.push(t) > 1)) {
                var r = v((function() { for (delete C[e]; t = o.shift();) t.apply(null, arguments) }));
                if (c) {
                    var n = new a;
                    ...
                    var l = p(i.document)("script", { async: !0, src: e + (-1 !== e.indexOf("?") ? "&" : "?") + "callback=_" }),
        ...
        A = function(e, t, o) {
            ...
            if (((f === l || f === "gist." + l) && "archive" === h[3] || f === l && "releases" === h[3] && ("download" === h[4] || "latest" === h[4] && "download" === h[5]) || f === "codeload." + l) && (c.target = "_top"), "true" === w(t["data-show-count"]) && f === l) {
                ...
                F.call(this, "https://api.github.com" + b, (function(e, t) {
                    if (!e) {
                        var a = t[g];
                        d.appendChild(r("a", { className: "social-count", href: t.html_url + u, rel: "noopener", target: "_blank", "aria-label": a + " " + g.replace(/_count$/, "").replace("_", " ").slice(0, a < 2 ? -1 : void 0) + " on GitHub" }, [("" + a).replace(/\B(?=(\d{3})+(?!\d))/g, ",")]))
                    }
                    o(d)
                }))
            } else o(d)
        ...
        L = function(e) { return (M > 1 ? o.ceil(o.round(e * M) / M * 2) / 2 : o.ceil(e)) || 0 },
        E = function(e, t) { e.style.width = t[0] + "px", e.style.height = t[1] + "px" },
        _ = function(t, r) {
            if (null != t && null != r)
                if (t.getAttribute && (t = function(e) {
                    ...
                    var a = b("span");
                    A(a.attachShadow({ mode: "closed" }), t, (function() { r(a) }))
                } else {
                    var n = b("iframe", { src: "javascript:0", title: t.title || void 0, allowtransparency: !0, scrolling: "no", frameBorder: 0 });
                    E(n, [0, 0]), n.style.border = "none";
                    var l = function() {
                        var a, c = n.contentWindow;
                        try { a = c.document.body } catch (t) { return void e.body.appendChild(n.parentNode.removeChild(n)) }
                        h(n, "load", l), A.call(c, a, t, (function(e) {
                            ...
                            n.parentNode.removeChild(n), u(n, "load", (function() { E(n, a) })), n.src = i + "#" + (n.name = function(e, t, o, r) {
    ...
    }((function() { for (var t = e.querySelectorAll ? e.querySelectorAll("a." + n) : function() { for (var t = [], o = e.getElementsByTagName("a"), r = 0, a = o.length; r < a; r++) - 1 !== (" " + o[r].className + " ").replace(/[ \t\n\f\r]+/g, " ").indexOf(" github-button ") && t.push(o[r]); return t }(), o = 0, r = t.length; o < r; o++) ! function(e) { _(e, (function(t) { e.parentNode.replaceChild(t, e) })) }(t[o]) }))
}();